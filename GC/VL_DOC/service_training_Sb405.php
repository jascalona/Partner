        ...
        <div class="offcanvas-body">
          ...
          <div class="btn-cont">
            ...
            <li class="nav-item dropdown">
              ...
              <ul class="dropdown-menu">
                <li><a class="dropdown-item" id="boton" onclick="ir_leccion14();">Carga y actualizaciones</a></li>
                <li><a class="dropdown-item" id="boton" onclick="ir_leccion14();">Actualización via browser</a></li>
                <li><a class="dropdown-item" id="boton" onclick="ir_leccion14();">Actualización via USB</a></li>
              </ul>
            </li>

            <li class="nav-item dropdown">
              <a class="nav-link dropdown-toggle" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                Permisos y Contabilidad
              </a>
              <ul class="dropdown-menu">
                <li><a class="dropdown-item" id="boton" onclick="ir_leccion15();">Metodo de Contabilidad XSA</a></li>
                <li><a class="dropdown-item" id="boton" onclick="ir_leccion15();">Metodo de Contabilidad de Red</a></li>
                <li><a class="dropdown-item" id="boton" onclick="ir_leccion16();">Trabajos Protejidos</a></li>
              </ul>
            </li>
          </div>
        ...
        <div class="carousel-inner">
          ...
          <div class="carousel-item" id="">
            ...
            <article class="content">
              ...
              <img src="./images/S/carrusel_2.png" alt="">
    ...
    <div id="leccion16" class="container-carac">
      ...
      <article class="item_carru" id="item13_carru">
        <div class="pp_carru" id="pp_item_13">
          ...
          <div class="content-general">
            <p class="paragraph">
              De Click en "Ir a la Evaluación" para comenzar la evaluación diagnostica<i class="ri-xbox-fill"></i> <i class="ri-vidicon-fill"></i>
            </p>
          </div>
