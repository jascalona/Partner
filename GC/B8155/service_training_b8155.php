...
<head>
    ...
    <title>XDV ELearning B8155</title>

    <!--STYLE ICON-->
    <link rel="stylesheet" href="./CSS_SERVICES/style_service.css">
    <link rel="stylesheet" href="./CSS_SERVICES/Bootstrap.css">
...
<body>
    ...
    <header>
        <p>Hola <strong><?php echo $_SESSION['name']; ?></strong>, Bienvenido al Curso de soporte para AltaLink B8155
        </p>
    </header>
        ...
        <div class="modal-menu">
            ...
            <div class="offcanvas offcanvas-start" data-bs-scroll="true" data-bs-backdrop="false" tabindex="-1"
                ...
                <div class="offcanvas-header">
                    <h5 class="offcanvas-title" id="offcanvasScrollingLabel">E-Learning B8155</h5>
                ...
                <div class="offcanvas-body">
                    ...
                    <!--#01-->
                    <details>
                        <summary>Característica <i class='bx bx-chevron-down' style='color:#4c4c4c'></i>
                        </summary>
                        <p><small>
                    ...
                    <!--#02-->
                    <details>
                        <summary>Instalación y Conexiones de red<i class='bx bx-chevron-down' style='color:#4c4c4c'></i>
                        </summary>
                        <p><small>
                                <a id="boton" onclick="ir_item_3();">Instalación de hardware</a>
                                <br>
                                <a id="boton" onclick="ir_item_8();">Configurar conexiones de red</a>
                                <br>
                                <a id="boton" onclick="ir_item_11();">Encendido/Apagado</a>
                                <br>
                            </small></p>
                    </details>
                    <!--#02-->
                    ...
                    <!--#03-->
                    <details>
                        <summary>Operación del Equipo<i class='bx bx-chevron-down' style='color:#4c4c4c'></i>
                        </summary>
                        <p><small>
                                <a id="boton" onclick="ir_item_12();">Controladores</a>
                                <br>
                                <a id="boton" onclick="ir_item_14();">Interfaz de Usuario</a>
                                <br>
                                <a id="boton" onclick="ir_item_16();">EWS</a>
                                <br>
                                <a id="boton" onclick="ir_item_18();">Instalacion de sistema operativo</a>
                            </small></p>
                    </details>
                    <!--#03-->
                    ...
                    <!--#04-->
                    <details>
                        <summary>Transporte de Papel <i class='bx bx-chevron-down' style='color:#4c4c4c'></i>
                        </summary>
                        <p><small>
                                <a id="boton" onclick="ir_item_21();">DADF ruta y atascos</a>
                                <br>
                                <a id="boton" onclick="ir_item_27();">Bandejas rutas y atascos</a>
                                <br>
                                <a id="boton" onclick="ir_item_33();">Suministros Y Partes de rotación</a>
                                <br>
                            </small></p>
                    </details>
                    <!--#04-->
                    ...
                    <!--#05-->
                    <details>
                        <summary>Mantenimiento<i class='bx bx-chevron-down' style='color:#4c4c4c'></i>
                        </summary>
                        <p><small>
                                <a id="boton" onclick="ir_item_37();">Mantenimiento del Cliente</a>
                                <br>
                                <a id="boton" onclick="ir_item_44();">Estado de maquina</a>
                            </small></p>
                    </details>
                    <!--#05-->
