        ...
        <div class="show-header">
          ...
          <div class="menu-modal-part" id="modal-8255">
            <button class="btn btn-dark" type="button" data-bs-toggle="offcanvas" data-bs-target="#offcanvasExampleB82"
              ...
              Parts List 82<i class='bx bxs-home'></i>
            </button>
              ...
              <div class="offcanvas-body">
                ...
                <details>
                  ...
                  <p><small>
                      ...
                      <br>
                      <a id="boton" onclick="ir_b8255_81();">PL 80.65 Left Cover Components</a>
                      <br>
                      <a id="boton" onclick="ir_b8255_82();">PL 80.70 Left Cover Transport Components</a>
                      <br>
                      <a id="boton" onclick="ir_b8255_83();">PL 80.75 Left Cover Transport Assembly</a>
                      <br>
                      <a id="boton" onclick="ir_b8255_84();">PL 80.80 Duplex Inner Chute Assembly</a>
                      <br>
                      <a id="boton" onclick="ir_b8255_85();">PL 80.85 Duplex Chute Assembly</a>
                      <br>
                      <a id="boton" onclick="ir_b8255_86();">PL 80.90 Registration Transport Assembly</a>
                      <br>
                      <a id="boton" onclick="ir_b8255_87();">PL 80.95 Registration Drive Assembly</a>
                      <br>
                      <a id="boton" onclick="ir_b8255_88();">PL 80.115 Bypass Tray Takeaway Assembly</a>
                      <br>
                      <a id="boton" onclick="ir_b8255_89();">PL 80.120 Bypass Tray Feedhead Assembly</a>
                    </small></p>
                </details>
                <!--#12-->
                ...
                <details>
                  ...
                  <p><small>
                      <a id="boton" onclick="ir_b8255_90();">PL 90.05 Developer Unit</a>
                      <br>
                      <a id="boton" onclick="ir_b8255_91();">PL 90.10 Toner Dispense</a>
                      <br>
                      <a id="boton" onclick="ir_b8255_92();">PL 90.15 Xerographic Components</a>
                      <br>
                      <a id="boton" onclick="ir_b8255_93();">PL 90.20 Xerographic Assembly (1 of 2)</a>
                      <br>
                      <a id="boton" onclick="ir_b8255_94();">PL 90.25 Xerographic Assembly (2 of 2)</a></li>
                      <br>
          ...
          <div class="container-b8255">
            ...
            <article class="item-article" id="b8255_75">
              <h6>PL 80 - Paper Transport</h6>
              <p>PL 80.40 TTM Transport Assembly / Tray 3 and 4 Feedhead Assembly</p>
              <img src="./IMG/images_pl_8255/PL 80.40 TTM Transport Assembly - Tray 3 and 4 Feedhead Assembly.png" alt="">
